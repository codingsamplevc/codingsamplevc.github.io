const test = {
  ...
  createSVG_Circle: (color) => {
    ...
    const _circle = document.createElement('circle', { cx: this.constants.svg.circle_xy, cy: this.constants.svg.circle_xy, r: test.constants.svg.circle_r, style: `fill:${color}` });
