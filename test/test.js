const test = {
  ...
  createSVG_Circle: (size,xy,radius,color) => {
    ...
    _circle.setAttributeNS("http://www.w3.org/2000/svg:circle", 'cx', xy);
    _circle.setAttributeNS("http://www.w3.org/2000/svg:circle", 'cy', xy);
    _circle.setAttributeNS("http://www.w3.org/2000/svg:circle", 'r', radius);
